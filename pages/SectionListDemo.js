...
const city = [{ data: ['1', '2', '3', '4'], title: "one" },
{ data: ['a', 'b', 'c', 'd'], title: "two" },
{ data: ['a1', 'b1', 'c1', 'd1'], title: "three" },
];



const SectionListDemo = ({ navigation, route }) => {
    const isDarkMode = useColorScheme() === 'dark';
    ...
    return (
        <SafeAreaView style={backgroundStyle}>
            ...
            <View >
                <SectionList sections={city}
                    renderItem={(data) => renderItem2(data)}
                    ...
                    renderSectionHeader={(data) => _renderHeader(data.section)}
